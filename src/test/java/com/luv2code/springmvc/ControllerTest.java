...
public class ControllerTest {
    ...
    public void getStudentHttpRequest() throws Exception {
        ...
        when(studentAndGradeService.getAllStudents()).thenReturn(collegeStudentList);
        assertIterableEquals(collegeStudentList , studentAndGradeService.getAllStudents());
    ...
    public void createStudentTest() throws Exception {
        CollegeStudent student1 = new CollegeStudent("Eric","Roby","eric.example@shit.com");
        CollegeStudent student2 = new CollegeStudent("Chad","Darby","chad.example@shit.com");
        List<CollegeStudent> collegeStudentList = new ArrayList<>(Arrays.asList(student1,student2));
        when(studentAndGradeService.getAllStudents()).thenReturn(collegeStudentList);
        assertIterableEquals(collegeStudentList , studentAndGradeService.getAllStudents());
